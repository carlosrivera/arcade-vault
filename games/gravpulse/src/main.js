...
const bokehPass = new BokehPass(scene, camera, { focus: 15, aperture: 0.0000032, maxblur: 0.0014 });
...
document.getElementById('lap-inc')?.addEventListener('click', (e) => {
  e.stopPropagation();
  setTotalLaps(totalLaps + 1);
});
document.getElementById('lap-dec')?.addEventListener('click', (e) => {
  e.stopPropagation();
  setTotalLaps(totalLaps - 1);
});
